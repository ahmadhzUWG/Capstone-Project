        ...
        public static async Task SeedRolesAndUsersAsync(IServiceProvider serviceProvider)
        {
            ...
            if (!context.Projects.Any())
            {
                ...
                if (adminUser != null)
                {
                    ...
                    {
                        new Project { Name = "Website Revamp", Description = "We revamp really good stuff", ProjectLeadId = adminUser.Id },
                        new Project { Name = "Mobile App Launch", Description = "We launch really good stuff", ProjectLeadId = adminUser.Id }
                    };
